...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_titledplugin', (
            ...
            ('font', self.gf('django.db.models.fields.CharField')(default='h2', max_length=50)),
        ))
        db.send_create_signal('cmsplugin_titledplugin', ['TitledPlugin'])


    def backwards(self, orm):
        # Deleting model 'TitledPlugin'
        db.delete_table('cmsplugin_titledplugin')

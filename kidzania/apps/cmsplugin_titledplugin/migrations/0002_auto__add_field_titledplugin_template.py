...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TitledPlugin.template'
        db.add_column('cmsplugin_titledplugin', 'template',
                      self.gf('django.db.models.fields.TextField')(default='default'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TitledPlugin.template'
        db.delete_column('cmsplugin_titledplugin', 'template')
    ...
    models = {
        ...
        'cmsplugin_titledplugin.titledplugin': {
            ...
            'font': ('django.db.models.fields.CharField', [], {'default': "'h2'", 'max_length': '50'}),
            'span': ('django.db.models.fields.CharField', [], {'default': "'Width'", 'max_length': '50'}),
            'template': ('django.db.models.fields.TextField', [], {'default': "'default'"}),

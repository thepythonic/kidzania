...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TitledImage'
        db.create_table('cmsplugin_titledimage', (
        ...
        db.send_create_signal('cmsplugin_titledimage', ['TitledImage'])


    def backwards(self, orm):
        # Deleting model 'TitledImage'
        db.delete_table('cmsplugin_titledimage')
